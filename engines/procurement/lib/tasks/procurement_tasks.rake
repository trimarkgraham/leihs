...
namespace :procurement do
  ...
  task seed: :environment do
    ...
    {12 => ["Services", "PZ"], 3881 => ["PZ", "Technik Produktion"],
     ...
     8479 => ["DKV", "Institut für Theorie"], 1973 => ["Services", "ITZ"],
    ...
    [{"id"=>6, "name"=>"AV", "email"=>"service.avt@zhdk.ch", :inspector_ids=>[350]},
     ...
     {"id"=>12, "name"=>"IT", "email"=>"service.itz@zhdk.ch", :inspector_ids=>[10, 1973, 317, 5824]},
    ...
    [{:group_id=>2, :budget_period_id=>2, :amount=>160000},
     ...
     {:group_id=>12, :budget_period_id=>2, :amount=>1900000},
    ...
    [{"budget_period_id" => 2, "group_id" => 6, "user_id" => 5824, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Eizo 19 Zoll LCD Monitor M190020589 SCH", "article_number" => nil, "requested_quantity" => 4, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 0, "price_currency" => "CHF", "priority" => "normal", "replacement" => false, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "test", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 8, "user_id" => 5824, "organization_id" => 4, "model_id" => 9443, "supplier_id" => 20, "location_id" => 8377, "article_name" => "Violabogen 3", "article_number" => "111223A", "requested_quantity" => 3, "approved_quantity" => 3, "order_quantity" => 3, "price_cents" => 250000, "price_currency" => "CHF", "priority" => "normal", "replacement" => false, "supplier_name" => "Schumacher&Frey GMBH", "receiver" => "Silvan Gretener", "location_name" => "Toni-Areal (TONI)  14.D.01", "motivation" => "Meine Begründung", "inspection_comment" => "Zwei reichen völlig aus"},
     {"budget_period_id" => 2, "group_id" => 10, "user_id" => 7815, "organization_id" => 44, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Bürotisch", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 50000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "USM", "receiver" => "Hans Ulrich Gasser", "location_name" => nil, "motivation" => "neuer MA", "inspection_comment" => nil},
     {"budget_period_id" => 4, "group_id" => 12, "user_id" => 7815, "organization_id" => 44, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "It Arbeitsplätze", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => 10, "order_quantity" => 10, "price_cents" => 120000, "price_currency" => "CHF", "priority" => "high", "replacement" => true, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "myasdfasdfsdf", "inspection_comment" => nil},
     {"budget_period_id" => 4, "group_id" => 12, "user_id" => 7815, "organization_id" => 44, "model_id" => 9823, "supplier_id" => nil, "location_id" => nil, "article_name" => "Aktivlautsprecher audioengine Modell audioengine 5", "article_number" => nil, "requested_quantity" => 2, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 0, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "motivation", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 2, "user_id" => 5824, "organization_id" => 4, "model_id" => 14450, "supplier_id" => nil, "location_id" => nil, "article_name" => "Funkmikrofon Handsender Sennheiser SKM 2000", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 0, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "dfsdf", "inspection_comment" => nil},
     {"budget_period_id" => 4, "group_id" => 6, "user_id" => 350, "organization_id" => 8, "model_id" => 2639, "supplier_id" => nil, "location_id" => nil, "article_name" => "Beamer Acer H7531D Full-HD", "article_number" => "keine Ahnung", "requested_quantity" => 1, "approved_quantity" => 0, "order_quantity" => 0, "price_cents" => 123400, "price_currency" => "CHF", "priority" => "high", "replacement" => true, "supplier_name" => "MC Donald", "receiver" => "Martin Weyermann", "location_name" => "5.B01-1", "motivation" => "Weil ich das will", "inspection_comment" => "nein"},
     {"budget_period_id" => 2, "group_id" => 8, "user_id" => 3848, "organization_id" => 42, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Panflöte", "article_number" => "8 Hölzig in Ges Dur", "requested_quantity" => 2, "approved_quantity" => 0, "order_quantity" => 0, "price_cents" => 1180000, "price_currency" => "CHF", "priority" => "high", "replacement" => true, "supplier_name" => "Musikhaus Gurtner", "receiver" => "Claire Gwendoline", "location_name" => "DMU 6.E04", "motivation" => "Bestehendes Instrument abgespielt", "inspection_comment" => "braucht es noch nicht für lange lange lange zeit"},
     {"budget_period_id" => 2, "group_id" => 12, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Laptop: Lenovo Thinkpad X301 Intel C2 Duo 1.4GHz/64GB SSD/Wireless/BT mit 4096MB RAM", "article_number" => nil, "requested_quantity" => 8, "approved_quantity" => 0, "order_quantity" => 0, "price_cents" => 230000, "price_currency" => "CHF", "priority" => "high", "replacement" => true, "supplier_name" => nil, "receiver" => "Hans Ueli Gasser", "location_name" => "Finanzen", "motivation" => "Endlich neue Computer", "inspection_comment" => "mit den neuen Akkus nicht mehr möglich"},
     {"budget_period_id" => 2, "group_id" => 6, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => 8966, "article_name" => "Beamer", "article_number" => nil, "requested_quantity" => 37, "approved_quantity" => 39, "order_quantity" => 42, "price_cents" => 950000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "der von Mike", "receiver" => "Barbara Berger", "location_name" => "Toni-Areal (TONI) 4.C12 itz-Büro ", "motivation" => "Ausstattung ITZ-Mitarbeitende für Home-Cinema", "inspection_comment" => "Darfs auch ein bisschen mehr sein?"},
     {"budget_period_id" => 2, "group_id" => 2, "user_id" => 350, "organization_id" => 8, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Schraubzwingen", "article_number" => "1234", "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 1300, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => "NSA", "receiver" => "Alex Stierli", "location_name" => "Büro Gessnerallee", "motivation" => "Dieso", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 4, "user_id" => 3848, "organization_id" => 42, "model_id" => nil, "supplier_id" => nil, "location_id" => 6549, "article_name" => "Hammondorgel mit Lesley", "article_number" => "Hammond", "requested_quantity" => 1, "approved_quantity" => 1, "order_quantity" => 1, "price_cents" => 2950000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "Musighüsli Zürich", "receiver" => "Chris Wiesendanger", "location_name" => "Toni-Areal (TONI) ZT 4.C12 ", "motivation" => "Move the Power ", "inspection_comment" => "schon lange gewünscht immer verschoben"},
     {"budget_period_id" => 2, "group_id" => 10, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => 9374, "article_name" => "Höhenverstellbares Pult", "article_number" => nil, "requested_quantity" => 15, "approved_quantity" => 10, "order_quantity" => 12, "price_cents" => 250000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "der von Marco", "receiver" => "Barbara Berger", "location_name" => "Toni-Areal (TONI) 4.C12 ITZ", "motivation" => "AS/GS-Vorgabe für IT-Mitarbeitende", "inspection_comment" => "Mit Desksharing Konzept kann Menge reduziert werden."},
     {"budget_period_id" => 2, "group_id" => 6, "user_id" => 3881, "organization_id" => 45, "model_id" => nil, "supplier_id" => nil, "location_id" => 9504, "article_name" => "Toyota Landcruiser", "article_number" => "HZj79", "requested_quantity" => 1, "approved_quantity" => 1, "order_quantity" => 2, "price_cents" => 7900000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "Toyota", "receiver" => "Alex Stierli", "location_name" => "Toni-Areal (TONI)  01.B.01", "motivation" => "Privater Ausflug", "inspection_comment" => "nein"},
     {"budget_period_id" => 2, "group_id" => 6, "user_id" => 350, "organization_id" => 8, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Adapter Laptop auf Konzertflügel", "article_number" => "667788990ADS12", "requested_quantity" => 67, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 200000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "Metzgerei Jenzer", "receiver" => "Pius Castelli", "location_name" => "Letzigrund", "motivation" => "Brauch das wichtig!!", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 6, "user_id" => 114, "organization_id" => 6, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "Infobildschirme Korridore", "article_number" => nil, "requested_quantity" => 300, "approved_quantity" => 1, "order_quantity" => 2, "price_cents" => 500000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "Mehr Information", "inspection_comment" => "einer muss reiechen. Soviel Infos gibt es gar nicht im Toni-Areal"},
     {"budget_period_id" => 2, "group_id" => 8, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => 9374, "article_name" => "Hammerflügel Paul McNulty nach Graf", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => 1, "order_quantity" => 1, "price_cents" => 3500000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "der von Martin", "receiver" => "Barbara Berger", "location_name" => "Toni-Areal (TONI) 4.C12 ITZ", "motivation" => "Für die ITZ-Partys", "inspection_comment" => "weiter so!!!"},
     {"budget_period_id" => 2, "group_id" => 4, "user_id" => 3881, "organization_id" => 45, "model_id" => nil, "supplier_id" => nil, "location_id" => 9504, "article_name" => "gabeltapler", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => 1, "order_quantity" => 1, "price_cents" => 9000000, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => "toyota", "receiver" => "Alex Stierli", "location_name" => "Toni-Areal (TONI)  01.B.01", "motivation" => "Lager bearbeitung", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 8, "user_id" => 350, "organization_id" => 8, "model_id" => 9193, "supplier_id" => nil, "location_id" => 8946, "article_name" => "Blockflöte Alt in f'", "article_number" => "67776", "requested_quantity" => 4, "approved_quantity" => 3, "order_quantity" => 3, "price_cents" => 1256700, "price_currency" => "CHF", "priority" => "high", "replacement" => true, "supplier_name" => "Musik Hug", "receiver" => "Ralph Wetli", "location_name" => "Toni-Areal (TONI) 6.A04 ", "motivation" => "Test", "inspection_comment" => "man kann auf beiden Seiten reinpusten"},
     {"budget_period_id" => 2, "group_id" => 10, "user_id" => 350, "organization_id" => 8, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "SOFA", "article_number" => "66", "requested_quantity" => 1, "approved_quantity" => 0, "order_quantity" => 0, "price_cents" => 87600, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "Ikea", "receiver" => "Mike Honegger", "location_name" => "6.A05", "motivation" => "Will liegen", "inspection_comment" => "Keine Ikea Möbel im Hause"},
     {"budget_period_id" => 2, "group_id" => 4, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => nil, "location_id" => 7711, "article_name" => "Discobeleutung", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 80000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "der von Alex", "receiver" => "Barbara Berger", "location_name" => "Toni-Areal (TONI) 4.K01 / ITZ Shop Theke Support", "motivation" => "Für die Shop ITZ-Partys", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 2, "user_id" => 114, "organization_id" => 6, "model_id" => 8805, "supplier_id" => nil, "location_id" => nil, "article_name" => " LED Profilscheinwerfer, 200W, 36° ETC Source Four LED LUSTR+ ", "article_number" => nil, "requested_quantity" => 33, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 348000, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => nil, "receiver" => "Marco Castellano", "location_name" => nil, "motivation" => "Mehr Licht im neuen Jahr", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 4, "user_id" => 3881, "organization_id" => 45, "model_id" => 9703, "supplier_id" => nil, "location_id" => nil, "article_name" => "ELC Truss switch", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 0, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "neeue verkabelung", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 8, "user_id" => 3848, "organization_id" => 42, "model_id" => nil, "supplier_id" => nil, "location_id" => 9242, "article_name" => "Beamer mit Hellraumprojekterfunktion auf eckigen Rollen", "article_number" => "4507-122 C", "requested_quantity" => 5, "approved_quantity" => 5, "order_quantity" => 5, "price_cents" => 745000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "IKEA-ALDI-LIDLGmbH & Co KG", "receiver" => "Ludwing von Mozart", "location_name" => "Toni-Areal (TONI) 07.G.01 ", "motivation" => "Präsentation Bundesratsempfänge", "inspection_comment" => "Für Dich doch alles, mein Lieber"},
     ...
     {"budget_period_id" => 2, "group_id" => 2, "user_id" => 3881, "organization_id" => 45, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "werksttwagen", "article_number" => nil, "requested_quantity" => 4, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 70000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "Hat der Mann in der Höle nie genug", "inspection_comment" => nil},
     {"budget_period_id" => 2, "group_id" => 6, "user_id" => 10, "organization_id" => 4, "model_id" => nil, "supplier_id" => 58, "location_id" => nil, "article_name" => "Speicherplatz für den Filer", "article_number" => "Netapp", "requested_quantity" => 10, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 3000000, "price_currency" => "CHF", "priority" => "high", "replacement" => false, "supplier_name" => "gib-Solutions", "receiver" => "Christian Wildhaber", "location_name" => "ITZ Serverraum", "motivation" => "Der Speicher ist fast voll", "inspection_comment" => nil},
     ...
     {"budget_period_id" => 4, "group_id" => 6, "user_id" => 350, "organization_id" => 8, "model_id" => nil, "supplier_id" => nil, "location_id" => nil, "article_name" => "doof", "article_number" => nil, "requested_quantity" => 1, "approved_quantity" => nil, "order_quantity" => nil, "price_cents" => 600, "price_currency" => "CHF", "priority" => "normal", "replacement" => true, "supplier_name" => nil, "receiver" => nil, "location_name" => nil, "motivation" => "dieso", "inspection_comment" => nil}
      ...
      # h[:price] = h.delete("price_cents").to_i
      Procurement::Request.create h
    end
